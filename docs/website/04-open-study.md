...
| Editorial article, published PDF (v1) | `site/research/2026/diffci-path-rule-article-v1.pdf` | Founder-supplied typeset version with three figures, copied in unmodified 2026-09-03. **Permanent URL** `https://diffci.com/research/2026/diffci-path-rule-article-v1.pdf`, hash-pinned in [`permalinks.md`](permalinks.md). Superseded by v2 but never edited or moved |
| Editorial article, published PDF (v2) | `site/research/2026/diffci-path-rule-article-v2.pdf` | Founder's expanded typeset version (five figures) with three figure-label corrections applied to the chart images, 2026-09-03; text and numbers unchanged. **Permanent URL** `https://diffci.com/research/2026/diffci-path-rule-article-v2.pdf`, hash-pinned; this is what the study's "Download and cite" and the study PDF link to. A revision is a new `-v3` file, never an edit |
