...
| Homepage | `site/index.html` | A fourth card in the evidence section and a footer link, both to the study only. Founder decision 2026-09-03: the article PDF is linked from the study page ("Download and cite"), never directly from nav or cards |
