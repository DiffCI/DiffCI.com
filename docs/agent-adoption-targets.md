...
| --- | --- | --- |
| [Official MCP Registry](https://github.com/modelcontextprotocol/registry) | Publish with GitHub OIDC as `io.github.DiffCI/diffci`. | Publishing under the authorized organization namespace. |
